    ...
    return (
      <div className={cn("relative inline-block", className)}>
        ...
        {removable && (
          <button
            type="button"
            className="absolute top-1 right-1 z-10 rounded-full bg-foreground/80 text-background hover:bg-foreground"
            onClick={onRemove}
    ...
    return (
      ...
      >
        ...
        {removable && (
          <button
            type="button"
            className="ml-2 self-start rounded-full bg-secondary p-1 text-primary hover:bg-secondary/80"
            onClick={onRemove}
  ...
  return (
    ...
    >
      ...
      {removable && (
        <button
          type="button"
          className="ml-2 rounded-full bg-secondary p-1 text-muted-foreground hover:bg-secondary/80"
          onClick={onRemove}
